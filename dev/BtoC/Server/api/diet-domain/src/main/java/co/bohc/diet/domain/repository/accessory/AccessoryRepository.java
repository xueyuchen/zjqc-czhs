...
public interface AccessoryRepository extends JpaRepository<Accessory, Integer>, AccesstoryRepositoryCustom {
	...
	// @Query(
	// value = "SELECT a FROM Accessory a WHERE a.saleDt IS NULL AND
	// a.model.modelName = :modelName AND a.style.styleName = :styleName AND
	// a.part.partName = :partName")
	// public List<Accessory> findByModelStylePart(@Param("modelName") String
	// modelName,
	// @Param("styleName") String styleName, @Param("partName") String
	// partName);
	...
	// @Query(value = "SELECT COUNT(a) FROM Accessory a WHERE a.saleDt IS NULL
	// AND a.model.modelId = :modelId AND a.style.styleId = :styleId AND
	// a.part.partId = :partId")
	// public Integer findCountByMSP(@Param("modelId") Integer modelId,
	// @Param("styleId") Integer styleId, @Param("partId") Integer partId);

	// @Query(value = "SELECT a FROM Accessory a WHERE a.saleDt IS NULL AND
	// a.model.brand.brandId = :brandId")
	// public List<Accessory> findByBrandId(@Param("brandId") Integer brandId,
	// Pageable pageable);

	// @Query(value = "SELECT COUNT(a) FROM Accessory a WHERE a.saleDt IS NULL
	// AND a.model.brand.brandId = :brandId")
	// public Integer countByBrandId(@Param("brandId") Integer brandId);

	// @Query(value = "SELECT a FROM Accessory a WHERE a.model.brand.brandId =
	// :brandId")
	// public List<Accessory> findByBrandIdAndSale(@Param("brandId") Integer
	// brandId);
	...
	public List<Accessory> findSaleByWeek(@Param("fromDt") Date fromDt, @Param("toDt") Date toDt);
